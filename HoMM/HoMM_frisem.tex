...
\end{column}
\end{columns}
\only<2>{\vspace{1em} Parsimonious \& allows for continued abstraction!}
...
\item We propose a parsimonious \textbf{HoMM} architecture that: 
    ...
    \end{itemize}
\item This approach performs comparably to humans in a card game task, and outperforms the language-based approach in some (but not all) settings.
