...
\begin{frame}[standout]
On this task, HoMM is not much worse than humans, and is substantially better than the language baseline.
\end{frame}
...
\section{Interactions with other timescales}
...
\begin{frame}[standout]
Starting from a good ``guess'' at the appropriate behavior results in faster learning, and orders of magnitude fewer cumulative mistakes.
\end{frame}
