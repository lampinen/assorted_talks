...
\frametitle<5>{Losing poker: switching to opposite rewards is challenging}
\centering
\only<1,5>{
...
\item We represent the task-specific computations as relatively simple transformations, parameterized from a task representation. The rest of architecture is shared across tasks.
...
\item And allows faster, better later learning. 
