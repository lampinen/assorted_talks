...
{
\centering
\includegraphics[width=0.9\textwidth]{figures/fodor_compositionality_1.png}
}
\vspace{-4em}
{\small But But is it really? (O'reilly et al., 2013)} % why the hell isn't that but showing up
\end{frame}
...
\only<1>{
\frametitle{Closer to human experience}
}
\only<2->{
\frametitle{Again, closer to human experience}
}
\centering
\includegraphics[width=\textwidth]{figures/baby_with_toy.png}
\end{frame}
...
%}
\only<1>{
\includegraphics[width=\textwidth]{figures/allo_vs_ego/b0.png}
}
\only<2>{
\includegraphics[width=\textwidth]{figures/allo_vs_ego/b1.png}
}
\only<3>{
\includegraphics[width=\textwidth]{figures/allo_vs_ego/b2.png}
}
\only<4>{
\includegraphics[width=\textwidth]{figures/allo_vs_ego/b3.png}
}
\end{frame}
